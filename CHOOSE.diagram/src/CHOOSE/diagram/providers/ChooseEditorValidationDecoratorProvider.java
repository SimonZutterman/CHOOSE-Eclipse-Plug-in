...
import CHOOSE.diagram.part.ChooseEditorDiagramEditor;
 ...
 * @generated
 */
public class ChooseEditorValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = ChooseEditorDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ChooseEditorDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& DiagramEditPart.MODEL_ID.equals(ChooseEditorVisualIDRegistry
						.getModelID(view));
	}
