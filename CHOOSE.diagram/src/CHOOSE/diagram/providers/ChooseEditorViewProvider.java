 ...
 * @generated
 */
public class ChooseEditorViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ChooseEditorVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = ChooseEditorVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!ChooseEditorElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != ChooseEditorVisualIDRegistry
				...
				if (!DiagramEditPart.MODEL_ID
						.equals(ChooseEditorVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return GoalEditPart.VISUAL_ID == visualID
				|| RefinementEditPart.VISUAL_ID == visualID
				|| ActorEditPart.VISUAL_ID == visualID
				|| HumanActorEditPart.VISUAL_ID == visualID
				|| RoleEditPart.VISUAL_ID == visualID
				|| SoftwareActorEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ChooseEditorVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = ChooseEditorVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case GoalEditPart.VISUAL_ID:
		...
		case RefinementEditPart.VISUAL_ID:
			return createRefinement_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case ActorEditPart.VISUAL_ID:
			return createActor_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case HumanActorEditPart.VISUAL_ID:
			return createHumanActor_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case RoleEditPart.VISUAL_ID:
			return createRole_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case SoftwareActorEditPart.VISUAL_ID:
			return createSoftwareActor_2006(domainElement, containerView,
					index, persisted, preferencesHint);
		case DeviceEditPart.VISUAL_ID:
			return createDevice_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case OperationEditPart.VISUAL_ID:
			return createOperation_2008(domainElement, containerView, index,
					persisted, preferencesHint);
		case ProcessEditPart.VISUAL_ID:
			return createProcess_2009(domainElement, containerView, index,
					persisted, preferencesHint);
		case ProjectEditPart.VISUAL_ID:
			return createProject_2010(domainElement, containerView, index,
					persisted, preferencesHint);
		case ObjectEditPart.VISUAL_ID:
			return createObject_2011(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ChooseEditorVisualIDRegistry.getVisualID(elementTypeHint)) {
		case GoalAssignedToEditPart.VISUAL_ID:
			return createGoalAssignedTo_4001(containerView, index, persisted,
					preferencesHint);
		case GoalWishedByEditPart.VISUAL_ID:
			return createGoalWishedBy_4002(containerView, index, persisted,
					preferencesHint);
		case GoalOrEditPart.VISUAL_ID:
			return createGoalOr_4003(containerView, index, persisted,
					preferencesHint);
		case GoalAndEditPart.VISUAL_ID:
			return createGoalAnd_4004(containerView, index, persisted,
					preferencesHint);
		case GoalConflictedEditPart.VISUAL_ID:
			return createGoalConflicted_4005(containerView, index, persisted,
					preferencesHint);
		case GoalConflictsEditPart.VISUAL_ID:
			return createGoalConflicts_4006(containerView, index, persisted,
					preferencesHint);
		case GoalConcernsObjectsEditPart.VISUAL_ID:
			return createGoalConcernsObjects_4007(containerView, index,
					persisted, preferencesHint);
		case GoalOperationalizedByEditPart.VISUAL_ID:
			return createGoalOperationalizedBy_4008(containerView, index,
					persisted, preferencesHint);
		case RefinementSupergoalEditPart.VISUAL_ID:
			return createRefinementSupergoal_4009(containerView, index,
					persisted, preferencesHint);
		case RefinementSubgoalsEditPart.VISUAL_ID:
			return createRefinementSubgoals_4010(containerView, index,
					persisted, preferencesHint);
		case ActorContainerWishesEditPart.VISUAL_ID:
			return createActorContainerWishes_4018(containerView, index,
					persisted, preferencesHint);
		case ActorContainerConsultedForEditPart.VISUAL_ID:
			return createActorContainerConsultedFor_4012(containerView, index,
					persisted, preferencesHint);
		case ActorContainerInformedForEditPart.VISUAL_ID:
			return createActorContainerInformedFor_4013(containerView, index,
					persisted, preferencesHint);
		case HumanActorSupervisorsEditPart.VISUAL_ID:
			return createHumanActorSupervisors_4014(containerView, index,
					persisted, preferencesHint);
		case HumanActorSuperviseesEditPart.VISUAL_ID:
			return createHumanActorSupervisees_4015(containerView, index,
					persisted, preferencesHint);
		case ActorContainerAssignmentsEditPart.VISUAL_ID:
			return createActorContainerAssignments_4011(containerView, index,
					persisted, preferencesHint);
		case RolePerformedByEditPart.VISUAL_ID:
			return createRolePerformedBy_4017(containerView, index, persisted,
					preferencesHint);
		case HumanActorPerformsEditPart.VISUAL_ID:
			return createHumanActorPerforms_4016(containerView, index,
					persisted, preferencesHint);
		case ActorContainerMonitorsEditPart.VISUAL_ID:
			return createActorContainerMonitors_4019(containerView, index,
					persisted, preferencesHint);
		case ActorContainerControlsEditPart.VISUAL_ID:
			return createActorContainerControls_4020(containerView, index,
					persisted, preferencesHint);
		case ActorContainerAccountableForEditPart.VISUAL_ID:
			return createActorContainerAccountableFor_4021(containerView,
					index, persisted, preferencesHint);
		case ActorContainerResponsibleForEditPart.VISUAL_ID:
			return createActorContainerResponsibleFor_4022(containerView,
					index, persisted, preferencesHint);
		case ActorContainerPartOfEditPart.VISUAL_ID:
			return createActorContainerPartOf_4023(containerView, index,
					persisted, preferencesHint);
		case ActorContainerIncludesEditPart.VISUAL_ID:
			return createActorContainerIncludes_4024(containerView, index,
					persisted, preferencesHint);
		case OperationContainerResponsibleEditPart.VISUAL_ID:
			return createOperationContainerResponsible_4025(containerView,
					index, persisted, preferencesHint);
		case OperationContainerInformEditPart.VISUAL_ID:
			return createOperationContainerInform_4027(containerView, index,
					persisted, preferencesHint);
		case OperationContainerConsultEditPart.VISUAL_ID:
			return createOperationContainerConsult_4026(containerView, index,
					persisted, preferencesHint);
		case OperationContainerAccountableEditPart.VISUAL_ID:
			return createOperationContainerAccountable_4028(containerView,
					index, persisted, preferencesHint);
		case OperationContainerPartOfEditPart.VISUAL_ID:
			return createOperationContainerPartOf_4029(containerView, index,
					persisted, preferencesHint);
		case OperationContainerIncludesEditPart.VISUAL_ID:
			return createOperationContainerIncludes_4030(containerView, index,
					persisted, preferencesHint);
		case OperationContainerOperationalizesEditPart.VISUAL_ID:
			return createOperationContainerOperationalizes_4031(containerView,
					index, persisted, preferencesHint);
		case OperationContainerOutputEditPart.VISUAL_ID:
			return createOperationContainerOutput_4032(containerView, index,
					persisted, preferencesHint);
		case OperationContainerInputEditPart.VISUAL_ID:
			return createOperationContainerInput_4033(containerView, index,
					persisted, preferencesHint);
		case ObjectConcernsGoalsEditPart.VISUAL_ID:
			return createObjectConcernsGoals_4038(containerView, index,
					persisted, preferencesHint);
		case ObjectMonitoredByEditPart.VISUAL_ID:
			return createObjectMonitoredBy_4034(containerView, index,
					persisted, preferencesHint);
		case ObjectInputForEditPart.VISUAL_ID:
			return createObjectInputFor_4036(containerView, index, persisted,
					preferencesHint);
		case ObjectOutputOfEditPart.VISUAL_ID:
			return createObjectOutputOf_4037(containerView, index, persisted,
					preferencesHint);
		case ObjectControlledByEditPart.VISUAL_ID:
			return createObjectControlledBy_4035(containerView, index,
					persisted, preferencesHint);
		case ObjectAssociatesEditPart.VISUAL_ID:
			return createObjectAssociates_4039(containerView, index, persisted,
					preferencesHint);
		case ObjectAssociatedEditPart.VISUAL_ID:
			return createObjectAssociated_4040(containerView, index, persisted,
					preferencesHint);
		case ObjectSpecializationEditPart.VISUAL_ID:
			return createObjectSpecialization_4041(containerView, index,
					persisted, preferencesHint);
		case ObjectSpecializedByEditPart.VISUAL_ID:
			return createObjectSpecializedBy_4042(containerView, index,
					persisted, preferencesHint);
		case ObjectPartOfEditPart.VISUAL_ID:
			return createObjectPartOf_4043(containerView, index, persisted,
					preferencesHint);
		case ObjectIncludesEditPart.VISUAL_ID:
			return createObjectIncludes_4044(containerView, index, persisted,
					preferencesHint);
		}
	...
	public Node createGoal_2001(EObject domainElement, View containerView,
		...
		node.setType(ChooseEditorVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createRefinement_2002(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createHumanActor_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createSoftwareActor_2006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createDevice_2007(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createOperation_2008(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createProcess_2009(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createProject_2010(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createObject_2011(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Edge createGoalAssignedTo_4001(View containerView, int index,
		...
		edge.setType(ChooseEditorVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createGoalWishedBy_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createGoalOr_4003(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createGoalAnd_4004(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createGoalConflicted_4005(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createGoalConflicts_4006(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createGoalConcernsObjects_4007(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createGoalOperationalizedBy_4008(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createRefinementSupergoal_4009(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createRefinementSubgoals_4010(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createActorContainerWishes_4018(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createActorContainerConsultedFor_4012(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createActorContainerInformedFor_4013(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createHumanActorSupervisors_4014(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createHumanActorSupervisees_4015(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createActorContainerAssignments_4011(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createRolePerformedBy_4017(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createHumanActorPerforms_4016(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createActorContainerMonitors_4019(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createActorContainerControls_4020(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createActorContainerAccountableFor_4021(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createActorContainerResponsibleFor_4022(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createActorContainerPartOf_4023(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createActorContainerIncludes_4024(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createOperationContainerResponsible_4025(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createOperationContainerInform_4027(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createOperationContainerConsult_4026(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createOperationContainerAccountable_4028(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createOperationContainerPartOf_4029(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createOperationContainerIncludes_4030(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createOperationContainerOperationalizes_4031(
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createOperationContainerOutput_4032(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createOperationContainerInput_4033(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createObjectConcernsGoals_4038(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createObjectMonitoredBy_4034(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createObjectInputFor_4036(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createObjectOutputOf_4037(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createObjectControlledBy_4035(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createObjectAssociates_4039(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createObjectAssociated_4040(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createObjectSpecialization_4041(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createObjectSpecializedBy_4042(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createObjectPartOf_4043(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createObjectIncludes_4044(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
