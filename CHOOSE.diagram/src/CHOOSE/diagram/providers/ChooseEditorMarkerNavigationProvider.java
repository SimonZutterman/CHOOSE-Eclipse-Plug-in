...
import CHOOSE.diagram.part.ChooseEditorDiagramEditorUtil;

/**
 * @generated
 */
public class ChooseEditorMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = ChooseEditorDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ChooseEditorDiagramEditorUtil.selectElementsInDiagram(editor,
