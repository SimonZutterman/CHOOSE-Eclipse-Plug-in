...
public class ChooseEditorAdvancedPropertySection extends AbstractModelerPropertySection {
    ...
    public void createControls(final Composite parent,
        ...
        page = new ChooseEditorPropertySheetPage();
        UndoableModelPropertySheetEntry root = new ChooseEditorPropertySheetEntry(OperationHistoryFactory.getOperationHistory());
