...
import CHOOSE.diagram.edit.policies.SoftwareActorItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SoftwareActorEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SoftwareActorEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SoftwareActorItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new SoftwareActorFigure();
	}

	/**
	 * @generated
	 */
	public SoftwareActorFigure getPrimaryShape() {
		return (SoftwareActorFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SoftwareActorNameEditPart) {
			((SoftwareActorNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureSoftwareActorNameLabel());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof CHOOSE.diagram.edit.parts.SoftwareActorEditPart) {
			types.add(ChooseEditorElementTypes.ActorContainerPartOf_4023);
		}
	 ...
	 * @generated
	 */
	public class SoftwareActorFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureSoftwareActorNameLabel;

		/**
		 * @generated
		 */
		public SoftwareActorFigure() {
		...
		private void createContents() {
			...
			fFigureSoftwareActorNameLabel = new WrappingLabel();

			fFigureSoftwareActorNameLabel.setText("<...>");
			fFigureSoftwareActorNameLabel.setTextWrap(true);
			fFigureSoftwareActorNameLabel
					.setFont(FFIGURESOFTWAREACTORNAMELABEL_FONT);

			GridData constraintFFigureSoftwareActorNameLabel = new GridData();
			constraintFFigureSoftwareActorNameLabel.verticalAlignment = GridData.CENTER;
			constraintFFigureSoftwareActorNameLabel.horizontalAlignment = GridData.CENTER;
			constraintFFigureSoftwareActorNameLabel.horizontalIndent = 1;
			constraintFFigureSoftwareActorNameLabel.horizontalSpan = 1;
			constraintFFigureSoftwareActorNameLabel.verticalSpan = 1;
			constraintFFigureSoftwareActorNameLabel.grabExcessHorizontalSpace = true;
			constraintFFigureSoftwareActorNameLabel.grabExcessVerticalSpace = true;
			this.add(fFigureSoftwareActorNameLabel,
					constraintFFigureSoftwareActorNameLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureSoftwareActorNameLabel() {
			return fFigureSoftwareActorNameLabel;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGURESOFTWAREACTORNAMELABEL_FONT = new Font(
