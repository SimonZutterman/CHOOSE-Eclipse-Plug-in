...
import CHOOSE.diagram.edit.policies.ActorContainerAssignmentsItemSemanticEditPolicy;

/**
 * @generated
 */
public class ActorContainerAssignmentsEditPart extends ConnectionNodeEditPart
	 ...
	 * @generated
	 */
	public ActorContainerAssignmentsEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ActorContainerAssignmentsItemSemanticEditPolicy());
	}
	...
	protected Connection createConnectionFigure() {
		return new ActorAssignmentFigure();
	}

	/**
	 * @generated
	 */
	public ActorAssignmentFigure getPrimaryShape() {
		return (ActorAssignmentFigure) getFigure();
	}

	/**
	 * @generated
	 */
	public class ActorAssignmentFigure extends PolylineConnectionEx {

		/**
		 * @generated NOT
		 */
		public ActorAssignmentFigure() {
