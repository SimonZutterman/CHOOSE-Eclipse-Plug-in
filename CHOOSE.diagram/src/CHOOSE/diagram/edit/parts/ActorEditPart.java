...
import CHOOSE.diagram.edit.policies.ActorItemSemanticEditPolicy;
...
public class ActorEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof CHOOSE.diagram.edit.parts.ActorEditPart) {
			types.add(ChooseEditorElementTypes.ActorContainerPartOf_4023);
		}
	...
	public class ActorFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureActorNameLabel.setTextWrap(true);
			fFigureActorNameLabel.setFont(FFIGUREACTORNAMELABEL_FONT);

			GridData constraintFFigureActorNameLabel = new GridData();
			constraintFFigureActorNameLabel.verticalAlignment = GridData.CENTER;
			constraintFFigureActorNameLabel.horizontalAlignment = GridData.CENTER;
			constraintFFigureActorNameLabel.horizontalIndent = 1;
			constraintFFigureActorNameLabel.horizontalSpan = 1;
			constraintFFigureActorNameLabel.verticalSpan = 1;
			constraintFFigureActorNameLabel.grabExcessHorizontalSpace = true;
			constraintFFigureActorNameLabel.grabExcessVerticalSpace = true;
			this.add(fFigureActorNameLabel, constraintFFigureActorNameLabel);
	 ...
	 * @generated
	 */
	static final Font FFIGUREACTORNAMELABEL_FONT = new Font(
