...
import CHOOSE.diagram.edit.commands.ChooseEditorCreateShortcutDecorationsCommand;
import CHOOSE.diagram.edit.policies.DiagramCanonicalEditPolicy;
import CHOOSE.diagram.edit.policies.DiagramItemSemanticEditPolicy;
...
public class DiagramEditPart extends
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "ChooseEditor"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						ChooseEditorVisualIDRegistry.TYPED_INSTANCE));
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new ChooseEditorCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
