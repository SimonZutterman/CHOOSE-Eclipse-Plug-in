...
import CHOOSE.diagram.edit.policies.ChooseEditorTextSelectionEditPolicy;
 ...
 * @generated
 */
public class SoftwareActorNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SoftwareActorNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ChooseEditorTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return ChooseEditorElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ChooseEditorParserProvider
					.getParser(
							ChooseEditorElementTypes.SoftwareActor_2006,
							getParserElement(),
							ChooseEditorVisualIDRegistry
									.getType(CHOOSE.diagram.edit.parts.SoftwareActorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this,
					WrapTextCellEditor.class,
					ChooseEditorEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
