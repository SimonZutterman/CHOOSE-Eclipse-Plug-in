...
import CHOOSE.diagram.edit.policies.HumanActorPerformsItemSemanticEditPolicy;

/**
 * @generated
 */
public class HumanActorPerformsEditPart extends ConnectionNodeEditPart
	 ...
	 * @generated
	 */
	public HumanActorPerformsEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new HumanActorPerformsItemSemanticEditPolicy());
	}
	...
	protected Connection createConnectionFigure() {
		return new ActorPerformsRoleFigure();
	}

	/**
	 * @generated
	 */
	public ActorPerformsRoleFigure getPrimaryShape() {
		return (ActorPerformsRoleFigure) getFigure();
	}

	/**
	 * @generated
	 */
	public class ActorPerformsRoleFigure extends PolylineConnectionEx {

		/**
		 * @generated NOT
		 */
		public ActorPerformsRoleFigure() {
