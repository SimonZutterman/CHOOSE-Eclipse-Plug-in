...
import CHOOSE.diagram.edit.policies.HumanActorItemSemanticEditPolicy;
 ...
 * @generated
 */
public class HumanActorEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public HumanActorEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new HumanActorItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new HumanActorFigure();
	}

	/**
	 * @generated
	 */
	public HumanActorFigure getPrimaryShape() {
		return (HumanActorFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof HumanActorNameEditPart) {
			((HumanActorNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureHumanActorNameLabel());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof CHOOSE.diagram.edit.parts.HumanActorEditPart) {
			types.add(ChooseEditorElementTypes.HumanActorSupervisors_4014);
		}
		if (targetEditPart instanceof CHOOSE.diagram.edit.parts.HumanActorEditPart) {
			types.add(ChooseEditorElementTypes.HumanActorSupervisees_4015);
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		...
		if (relationshipType == ChooseEditorElementTypes.ActorContainerWishes_4018) {
			...
			types.add(ChooseEditorElementTypes.Process_2009);
			types.add(ChooseEditorElementTypes.Project_2010);
		} else if (relationshipType == ChooseEditorElementTypes.HumanActorSupervisors_4014) {
			types.add(ChooseEditorElementTypes.HumanActor_2004);
		} else if (relationshipType == ChooseEditorElementTypes.HumanActorSupervisees_4015) {
			types.add(ChooseEditorElementTypes.HumanActor_2004);
		} else if (relationshipType == ChooseEditorElementTypes.ActorContainerAssignments_4011) {
			types.add(ChooseEditorElementTypes.Goal_2001);
		} else if (relationshipType == ChooseEditorElementTypes.HumanActorPerforms_4016) {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == ChooseEditorElementTypes.GoalAssignedTo_4001) {
			...
			types.add(ChooseEditorElementTypes.HumanActor_2004);
		} else if (relationshipType == ChooseEditorElementTypes.RolePerformedBy_4017) {
			types.add(ChooseEditorElementTypes.Role_2005);
		} else if (relationshipType == ChooseEditorElementTypes.ActorContainerPartOf_4023) {
			types.add(ChooseEditorElementTypes.Actor_2003);
			types.add(ChooseEditorElementTypes.HumanActor_2004);
	 ...
	 * @generated
	 */
	public class HumanActorFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureHumanActorNameLabel;

		/**
		 * @generated
		 */
		public HumanActorFigure() {
		...
		private void createContents() {
			...
			fFigureHumanActorNameLabel = new WrappingLabel();

			fFigureHumanActorNameLabel.setText("<...>");
			fFigureHumanActorNameLabel.setTextWrap(true);
			fFigureHumanActorNameLabel.setFont(FFIGUREHUMANACTORNAMELABEL_FONT);

			GridData constraintFFigureHumanActorNameLabel = new GridData();
			constraintFFigureHumanActorNameLabel.verticalAlignment = GridData.CENTER;
			constraintFFigureHumanActorNameLabel.horizontalAlignment = GridData.CENTER;
			constraintFFigureHumanActorNameLabel.horizontalIndent = 1;
			constraintFFigureHumanActorNameLabel.horizontalSpan = 1;
			constraintFFigureHumanActorNameLabel.verticalSpan = 1;
			constraintFFigureHumanActorNameLabel.grabExcessHorizontalSpace = true;
			constraintFFigureHumanActorNameLabel.grabExcessVerticalSpace = true;
			this.add(fFigureHumanActorNameLabel,
					constraintFFigureHumanActorNameLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureHumanActorNameLabel() {
			return fFigureHumanActorNameLabel;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGUREHUMANACTORNAMELABEL_FONT = new Font(
