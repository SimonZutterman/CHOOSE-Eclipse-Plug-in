...
import CHOOSE.diagram.edit.policies.RoleItemSemanticEditPolicy;
...
public class RoleEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new RoleActorFigure();
	}

	/**
	 * @generated
	 */
	public RoleActorFigure getPrimaryShape() {
		return (RoleActorFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof CHOOSE.diagram.edit.parts.RoleEditPart) {
			types.add(ChooseEditorElementTypes.ActorContainerPartOf_4023);
		}
	 ...
	 * @generated
	 */
	public class RoleActorFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureRoleNameLabel.setTextWrap(true);
			fFigureRoleNameLabel.setFont(FFIGUREROLENAMELABEL_FONT);
			...
			constraintFFigureRoleNameLabel.horizontalIndent = 1;
	 ...
	 * @generated
	 */
	static final Font FFIGUREROLENAMELABEL_FONT = new Font(
