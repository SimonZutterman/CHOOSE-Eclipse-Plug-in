...
import CHOOSE.diagram.edit.policies.ActorContainerWishesItemSemanticEditPolicy;

/**
 * @generated
 */
public class ActorContainerWishesEditPart extends ConnectionNodeEditPart
	 ...
	 * @generated
	 */
	public ActorContainerWishesEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ActorContainerWishesItemSemanticEditPolicy());
	}
	...
	protected Connection createConnectionFigure() {
		return new ActorWishFigure();
	}

	/**
	 * @generated
	 */
	public ActorWishFigure getPrimaryShape() {
		return (ActorWishFigure) getFigure();
	}

	/**
	 * @generated
	 */
	public class ActorWishFigure extends PolylineConnectionEx {

		/**
		 * @generated NOT
		 */
		public ActorWishFigure() {
