...
import CHOOSE.diagram.edit.policies.RefinementItemSemanticEditPolicy;
...
public class RefinementEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RefinementItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new RefinementFigure();
	}
	...
	public RefinementFigure getPrimaryShape() {
		return (RefinementFigure) primaryShape;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == ChooseEditorElementTypes.RefinementSupergoal_4009) {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == ChooseEditorElementTypes.GoalOr_4003) {
			types.add(ChooseEditorElementTypes.Goal_2001);
	 ...
	 * @generated
	 */
	public class RefinementFigure extends Ellipse {
