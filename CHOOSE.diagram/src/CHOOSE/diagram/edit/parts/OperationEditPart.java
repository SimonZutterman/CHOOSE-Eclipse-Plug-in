...
import CHOOSE.diagram.edit.policies.OperationItemSemanticEditPolicy;
...
public class OperationEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof CHOOSE.diagram.edit.parts.OperationEditPart) {
			types.add(ChooseEditorElementTypes.OperationContainerPartOf_4029);
		}
	...
	public class OperationFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureOperationNameLabel.setTextWrap(true);
			fFigureOperationNameLabel.setFont(FFIGUREOPERATIONNAMELABEL_FONT);

			GridData constraintFFigureOperationNameLabel = new GridData();
			constraintFFigureOperationNameLabel.verticalAlignment = GridData.CENTER;
			constraintFFigureOperationNameLabel.horizontalAlignment = GridData.CENTER;
			constraintFFigureOperationNameLabel.horizontalIndent = 1;
			constraintFFigureOperationNameLabel.horizontalSpan = 1;
			constraintFFigureOperationNameLabel.verticalSpan = 1;
			constraintFFigureOperationNameLabel.grabExcessHorizontalSpace = true;
			constraintFFigureOperationNameLabel.grabExcessVerticalSpace = true;
			this.add(fFigureOperationNameLabel,
					constraintFFigureOperationNameLabel);
	 ...
	 * @generated
	 */
	static final Font FFIGUREOPERATIONNAMELABEL_FONT = new Font(
