...
import CHOOSE.diagram.edit.policies.RolePerformedByItemSemanticEditPolicy;

/**
 * @generated
 */
public class RolePerformedByEditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {
	 ...
	 * @generated
	 */
	public RolePerformedByEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RolePerformedByItemSemanticEditPolicy());
	}
	...
	protected Connection createConnectionFigure() {
		return new ActorPerformedByFigure();
	}

	/**
	 * @generated
	 */
	public ActorPerformedByFigure getPrimaryShape() {
		return (ActorPerformedByFigure) getFigure();
	}

	/**
	 * @generated
	 */
	public class ActorPerformedByFigure extends PolylineConnectionEx {

		/**
		 * @generated NOT
		 */
		public ActorPerformedByFigure() {
