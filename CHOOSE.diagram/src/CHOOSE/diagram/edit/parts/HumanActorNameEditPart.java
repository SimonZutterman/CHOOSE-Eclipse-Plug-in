 ...
 * @generated
 */
public class HumanActorNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HumanActorNameEditPart(View view) {
		super(view);
	}
			...
			parser = ChooseEditorParserProvider
					.getParser(
							...
							ChooseEditorVisualIDRegistry
									.getType(CHOOSE.diagram.edit.parts.HumanActorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
