 ...
 * @generated
 */
public class RefinementSupergoalCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RefinementSupergoalCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRefinementSupergoal_4009(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setSupergoal(getTarget());
		}
