 ...
 * @generated
 */
public class ActorContainerConsultedForReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ActorContainerConsultedForReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerConsultedFor_4012(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerConsultedFor_4012(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getConsultedFor().remove(getOldTarget());
		getNewSource().getConsultedFor().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getConsultedFor().remove(getOldTarget());
		getOldSource().getConsultedFor().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
