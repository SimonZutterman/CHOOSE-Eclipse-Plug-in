 ...
 * @generated
 */
public class OperationContainerOutputReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OperationContainerOutputReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Object && newEnd instanceof OperationContainer)) {
			return false;
		}
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOperationContainerOutput_4032(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOperationContainerOutput_4032(getOldSource(),
						getNewTarget());
	}
