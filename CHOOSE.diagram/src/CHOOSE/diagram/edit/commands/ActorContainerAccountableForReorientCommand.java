 ...
 * @generated
 */
public class ActorContainerAccountableForReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ActorContainerAccountableForReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerAccountableFor_4021(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerAccountableFor_4021(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getAccountableFor().remove(getOldTarget());
		getNewSource().getAccountableFor().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getAccountableFor().remove(getOldTarget());
		getOldSource().getAccountableFor().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
