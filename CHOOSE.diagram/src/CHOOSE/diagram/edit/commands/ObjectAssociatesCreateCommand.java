 ...
 * @generated
 */
public class ObjectAssociatesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectAssociatesCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateObjectAssociates_4039(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getAssociates().add(getTarget());
		}
