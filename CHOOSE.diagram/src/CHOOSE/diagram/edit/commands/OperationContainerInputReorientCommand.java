 ...
 * @generated
 */
public class OperationContainerInputReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OperationContainerInputReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOperationContainerInput_4033(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOperationContainerInput_4033(getOldSource(),
						getNewTarget());
	}
