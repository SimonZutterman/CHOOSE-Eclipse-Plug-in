 ...
 * @generated
 */
public class ActorContainerResponsibleForReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ActorContainerResponsibleForReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerResponsibleFor_4022(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerResponsibleFor_4022(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getResponsibleFor().remove(getOldTarget());
		getNewSource().getResponsibleFor().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getResponsibleFor().remove(getOldTarget());
		getOldSource().getResponsibleFor().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
