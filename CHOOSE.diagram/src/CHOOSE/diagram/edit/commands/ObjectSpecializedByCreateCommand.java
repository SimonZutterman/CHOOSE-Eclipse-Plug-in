 ...
 * @generated
 */
public class ObjectSpecializedByCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectSpecializedByCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateObjectSpecializedBy_4042(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getSpecializedBy().add(getTarget());
		}
