 ...
 * @generated
 */
public class ObjectPartOfReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectPartOfReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectPartOf_4043(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectPartOf_4043(getOldSource(), getNewTarget());
	}
