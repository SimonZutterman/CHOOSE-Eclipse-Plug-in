 ...
 * @generated
 */
public class ObjectAssociatedCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectAssociatedCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateObjectAssociated_4040(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getAssociated().add(getTarget());
		}
