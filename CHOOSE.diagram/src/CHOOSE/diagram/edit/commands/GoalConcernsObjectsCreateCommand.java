 ...
 * @generated
 */
public class GoalConcernsObjectsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalConcernsObjectsCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateGoalConcernsObjects_4007(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getConcernsObjects().add(getTarget());
		}
