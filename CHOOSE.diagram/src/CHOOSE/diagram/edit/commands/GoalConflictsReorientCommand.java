 ...
 * @generated
 */
public class GoalConflictsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalConflictsReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalConflicts_4006(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalConflicts_4006(getOldSource(), getNewTarget());
	}
