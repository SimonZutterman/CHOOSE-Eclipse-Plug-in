 ...
 * @generated
 */
public class RefinementSupergoalReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RefinementSupergoalReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRefinementSupergoal_4009(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRefinementSupergoal_4009(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setSupergoal(null);
		getNewSource().setSupergoal(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setSupergoal(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
