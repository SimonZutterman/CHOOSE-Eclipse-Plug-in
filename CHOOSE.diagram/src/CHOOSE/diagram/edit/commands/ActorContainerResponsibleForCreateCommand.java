 ...
 * @generated
 */
public class ActorContainerResponsibleForCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ActorContainerResponsibleForCreateCommand(
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateActorContainerResponsibleFor_4022(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getResponsibleFor().add(getTarget());
		}
