 ...
 * @generated
 */
public class ActorContainerControlsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActorContainerControlsReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerControls_4020(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerControls_4020(getOldSource(),
						getNewTarget());
	}
