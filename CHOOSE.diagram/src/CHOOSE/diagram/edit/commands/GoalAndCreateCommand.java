 ...
 * @generated
 */
public class GoalAndCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalAndCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateGoalAnd_4004(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getAnd().add(getTarget());
		}
