 ...
 * @generated
 */
public class ObjectConcernsGoalsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectConcernsGoalsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Goal && newEnd instanceof Object)) {
			return false;
		}
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectConcernsGoals_4038(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectConcernsGoals_4038(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getConcernsGoals().remove(getOldTarget());
		getNewSource().getConcernsGoals().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getConcernsGoals().remove(getOldTarget());
		getOldSource().getConcernsGoals().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
