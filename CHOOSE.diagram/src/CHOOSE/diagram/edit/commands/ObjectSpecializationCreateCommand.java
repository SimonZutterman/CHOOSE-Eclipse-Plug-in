 ...
 * @generated
 */
public class ObjectSpecializationCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectSpecializationCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateObjectSpecialization_4041(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getSpecialization().add(getTarget());
		}
