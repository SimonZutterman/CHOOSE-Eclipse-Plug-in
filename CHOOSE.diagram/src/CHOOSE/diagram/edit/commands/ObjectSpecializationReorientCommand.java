 ...
 * @generated
 */
public class ObjectSpecializationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectSpecializationReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectSpecialization_4041(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectSpecialization_4041(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getSpecialization().remove(getOldTarget());
		getNewSource().getSpecialization().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getSpecialization().remove(getOldTarget());
		getOldSource().getSpecialization().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
