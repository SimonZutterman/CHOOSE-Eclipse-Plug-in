 ...
 * @generated
 */
public class HumanActorSuperviseesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HumanActorSuperviseesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHumanActorSupervisees_4015(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHumanActorSupervisees_4015(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getSupervisees().remove(getOldTarget());
		getNewSource().getSupervisees().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getSupervisees().remove(getOldTarget());
		getOldSource().getSupervisees().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
