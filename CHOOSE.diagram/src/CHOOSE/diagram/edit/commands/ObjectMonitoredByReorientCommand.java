 ...
 * @generated
 */
public class ObjectMonitoredByReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectMonitoredByReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectMonitoredBy_4034(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectMonitoredBy_4034(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getMonitoredBy().remove(getOldTarget());
		getNewSource().getMonitoredBy().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getMonitoredBy().remove(getOldTarget());
		getOldSource().getMonitoredBy().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
