 ...
 * @generated
 */
public class ObjectOutputOfCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectOutputOfCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateObjectOutputOf_4037(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getOutputOf().add(getTarget());
		}
