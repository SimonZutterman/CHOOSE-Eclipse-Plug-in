 ...
 * @generated
 */
public class GoalOperationalizedByReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalOperationalizedByReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof OperationContainer && newEnd instanceof Goal)) {
			return false;
		}
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalOperationalizedBy_4008(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalOperationalizedBy_4008(getOldSource(),
						getNewTarget());
	}
