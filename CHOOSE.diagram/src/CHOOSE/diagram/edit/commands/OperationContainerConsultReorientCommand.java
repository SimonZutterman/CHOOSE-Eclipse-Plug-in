 ...
 * @generated
 */
public class OperationContainerConsultReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public OperationContainerConsultReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOperationContainerConsult_4026(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOperationContainerConsult_4026(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getConsult().remove(getOldTarget());
		getNewSource().getConsult().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getConsult().remove(getOldTarget());
		getOldSource().getConsult().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
