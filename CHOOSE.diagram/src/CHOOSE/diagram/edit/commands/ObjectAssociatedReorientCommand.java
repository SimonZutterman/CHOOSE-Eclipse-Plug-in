 ...
 * @generated
 */
public class ObjectAssociatedReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectAssociatedReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectAssociated_4040(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectAssociated_4040(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getAssociated().remove(getOldTarget());
		getNewSource().getAssociated().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getAssociated().remove(getOldTarget());
		getOldSource().getAssociated().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
