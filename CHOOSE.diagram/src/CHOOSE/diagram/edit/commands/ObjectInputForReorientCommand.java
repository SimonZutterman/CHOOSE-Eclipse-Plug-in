 ...
 * @generated
 */
public class ObjectInputForReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectInputForReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectInputFor_4036(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectInputFor_4036(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getInputFor().remove(getOldTarget());
		getNewSource().getInputFor().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getInputFor().remove(getOldTarget());
		getOldSource().getInputFor().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
