 ...
 * @generated
 */
public class ObjectSpecializedByReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectSpecializedByReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectSpecializedBy_4042(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectSpecializedBy_4042(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getSpecializedBy().remove(getOldTarget());
		getNewSource().getSpecializedBy().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getSpecializedBy().remove(getOldTarget());
		getOldSource().getSpecializedBy().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
