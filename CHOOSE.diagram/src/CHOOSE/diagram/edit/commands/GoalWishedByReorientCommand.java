 ...
 * @generated
 */
public class GoalWishedByReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalWishedByReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalWishedBy_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalWishedBy_4002(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getWishedBy().remove(getOldTarget());
		getNewSource().getWishedBy().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getWishedBy().remove(getOldTarget());
		getOldSource().getWishedBy().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
