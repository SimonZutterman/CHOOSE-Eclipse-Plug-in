 ...
 * @generated
 */
public class OperationContainerIncludesReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public OperationContainerIncludesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOperationContainerIncludes_4030(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOperationContainerIncludes_4030(getOldSource(),
						getNewTarget());
	}
