 ...
 * @generated
 */
public class ActorContainerPartOfReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActorContainerPartOfReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerPartOf_4023(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerPartOf_4023(getOldSource(),
						getNewTarget());
	}
