 ...
 * @generated
 */
public class ActorContainerMonitorsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActorContainerMonitorsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Object && newEnd instanceof ActorContainer)) {
			return false;
		}
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerMonitors_4019(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerMonitors_4019(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getMonitors().remove(getOldTarget());
		getNewSource().getMonitors().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getMonitors().remove(getOldTarget());
		getOldSource().getMonitors().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
