 ...
 * @generated
 */
public class GoalConflictedReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalConflictedReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalConflicted_4005(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalConflicted_4005(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getConflicted().remove(getOldTarget());
		getNewSource().getConflicted().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getConflicted().remove(getOldTarget());
		getOldSource().getConflicted().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
