 ...
 * @generated
 */
public class ObjectIncludesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectIncludesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectIncludes_4044(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistObjectIncludes_4044(getOldSource(), getNewTarget());
	}
