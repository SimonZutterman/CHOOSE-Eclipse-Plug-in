 ...
 * @generated
 */
public class ActorContainerAccountableForCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ActorContainerAccountableForCreateCommand(
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateActorContainerAccountableFor_4021(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getAccountableFor().add(getTarget());
		}
