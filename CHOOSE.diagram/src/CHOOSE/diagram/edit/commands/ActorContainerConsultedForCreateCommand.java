 ...
 * @generated
 */
public class ActorContainerConsultedForCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActorContainerConsultedForCreateCommand(
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateActorContainerConsultedFor_4012(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getConsultedFor().add(getTarget());
		}
