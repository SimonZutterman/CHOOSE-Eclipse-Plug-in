 ...
 * @generated
 */
public class HumanActorPerformsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HumanActorPerformsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Role && newEnd instanceof HumanActor)) {
			return false;
		}
		return ChooseEditorBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistHumanActorPerforms_4016(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistHumanActorPerforms_4016(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getPerforms().remove(getOldTarget());
		getNewSource().getPerforms().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getPerforms().remove(getOldTarget());
		getOldSource().getPerforms().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
