 ...
 * @generated
 */
public class GoalConflictedCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalConflictedCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateGoalConflicted_4005(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getConflicted().add(getTarget());
		}
