 ...
 * @generated
 */
public class ActorContainerWishesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActorContainerWishesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerWishes_4018(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistActorContainerWishes_4018(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getWishes().remove(getOldTarget());
		getNewSource().getWishes().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getWishes().remove(getOldTarget());
		getOldSource().getWishes().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
