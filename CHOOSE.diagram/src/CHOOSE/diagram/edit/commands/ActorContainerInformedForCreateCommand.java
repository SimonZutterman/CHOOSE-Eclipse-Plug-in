 ...
 * @generated
 */
public class ActorContainerInformedForCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActorContainerInformedForCreateCommand(
	...
	public boolean canExecute() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateActorContainerInformedFor_4013(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getInformedFor().add(getTarget());
		}
