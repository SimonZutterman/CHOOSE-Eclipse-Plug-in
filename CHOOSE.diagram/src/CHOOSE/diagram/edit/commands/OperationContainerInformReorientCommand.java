 ...
 * @generated
 */
public class OperationContainerInformReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OperationContainerInformReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOperationContainerInform_4027(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ChooseEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOperationContainerInform_4027(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getInform().remove(getOldTarget());
		getNewSource().getInform().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getInform().remove(getOldTarget());
		getOldSource().getInform().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
