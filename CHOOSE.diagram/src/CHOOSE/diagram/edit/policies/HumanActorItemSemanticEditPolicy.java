...
import CHOOSE.diagram.edit.commands.HumanActorPerformsCreateCommand;
import CHOOSE.diagram.edit.commands.HumanActorPerformsReorientCommand;
import CHOOSE.diagram.edit.commands.HumanActorSuperviseesCreateCommand;
import CHOOSE.diagram.edit.commands.HumanActorSuperviseesReorientCommand;
import CHOOSE.diagram.edit.commands.HumanActorSupervisorsCreateCommand;
import CHOOSE.diagram.edit.commands.HumanActorSupervisorsReorientCommand;
...
import CHOOSE.diagram.edit.commands.RolePerformedByCreateCommand;
import CHOOSE.diagram.edit.commands.RolePerformedByReorientCommand;
 ...
 * @generated
 */
public class HumanActorItemSemanticEditPolicy extends
		ChooseEditorBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public HumanActorItemSemanticEditPolicy() {
		super(ChooseEditorElementTypes.HumanActor_2004);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ChooseEditorVisualIDRegistry.getVisualID(incomingLink) == HumanActorSupervisorsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
			...
			if (ChooseEditorVisualIDRegistry.getVisualID(incomingLink) == HumanActorSuperviseesEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
			...
			if (ChooseEditorVisualIDRegistry.getVisualID(incomingLink) == RolePerformedByEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ChooseEditorVisualIDRegistry.getVisualID(outgoingLink) == HumanActorSupervisorsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
			...
			if (ChooseEditorVisualIDRegistry.getVisualID(outgoingLink) == HumanActorSuperviseesEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
			...
			if (ChooseEditorVisualIDRegistry.getVisualID(outgoingLink) == HumanActorPerformsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (ChooseEditorElementTypes.HumanActorSupervisors_4014 == req
				.getElementType()) {
			return getGEFWrapper(new HumanActorSupervisorsCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (ChooseEditorElementTypes.HumanActorSupervisees_4015 == req
				.getElementType()) {
			return getGEFWrapper(new HumanActorSuperviseesCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		...
		if (ChooseEditorElementTypes.RolePerformedBy_4017 == req
				.getElementType()) {
			return null;
		}
		if (ChooseEditorElementTypes.HumanActorPerforms_4016 == req
				.getElementType()) {
			return getGEFWrapper(new HumanActorPerformsCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (ChooseEditorElementTypes.RolePerformedBy_4017 == req
				.getElementType()) {
			return getGEFWrapper(new RolePerformedByCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (ChooseEditorElementTypes.HumanActorPerforms_4016 == req
				.getElementType()) {
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case HumanActorSupervisorsEditPart.VISUAL_ID:
			return getGEFWrapper(new HumanActorSupervisorsReorientCommand(req));
		case HumanActorSuperviseesEditPart.VISUAL_ID:
			return getGEFWrapper(new HumanActorSuperviseesReorientCommand(req));
		...
		case RolePerformedByEditPart.VISUAL_ID:
			return getGEFWrapper(new RolePerformedByReorientCommand(req));
		case HumanActorPerformsEditPart.VISUAL_ID:
			return getGEFWrapper(new HumanActorPerformsReorientCommand(req));
