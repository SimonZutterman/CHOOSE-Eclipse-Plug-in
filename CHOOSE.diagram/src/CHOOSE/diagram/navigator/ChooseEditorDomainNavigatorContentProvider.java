 ...
 * @generated
 */
public class ChooseEditorDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ChooseEditorDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ChooseEditorDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((ChooseEditorDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ChooseEditorDomainNavigatorItem(
