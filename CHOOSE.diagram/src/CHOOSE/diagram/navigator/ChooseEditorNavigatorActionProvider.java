 ...
 * @generated
 */
public class ChooseEditorNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof ChooseEditorNavigatorItem) {
					selectedElement = ((ChooseEditorNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, ChooseEditorDiagramEditor.ID);
