 ...
 * @generated
 */
public class ChooseEditorElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ChooseEditorElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.ChooseEditorElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "choose".equals(fileExtension) || "choose_diagram".equals(fileExtension); //$NON-NLS-1$ //$NON-NLS-2$
	}
