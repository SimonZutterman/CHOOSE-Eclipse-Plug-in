 ...
 * @generated
 */
public class ChooseEditorInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ChooseEditorNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				DiagramEditPart.MODEL_ID));
		ChooseEditorDiagramEditorUtil.runWizard(getShell(), wizard,
