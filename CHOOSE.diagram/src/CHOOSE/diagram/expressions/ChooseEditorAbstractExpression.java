 ...
 * @generated
 */
public abstract class ChooseEditorAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = ChooseEditorDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected ChooseEditorAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
